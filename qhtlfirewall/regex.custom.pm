...
# by qhtlfirewall upgrades. The format is slightly different to regex.pm to cater for
# additional parameters. You need to specify the log file that needs to be
# scanned for log line matches in qhtlfirewall.conf under CUSTOMx_LOG. You can scan up
...
# If the matches in this file are not syntactically correct for perl then qhtlwaterfall
