...
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.conf" ]; then
	cp -avf qhtlfirewall.directadmin.conf /etc/qhtlfirewall/qhtlfirewall.conf
fi
...
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.allow" ]; then
	cp -avf qhtlfirewall.directadmin.allow /etc/qhtlfirewall/qhtlfirewall.allow
fi
...
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.ignore" ]; then
	cp -avf qhtlfirewall.directadmin.ignore /etc/qhtlfirewall/qhtlfirewall.ignore
fi
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.pignore" ]; then
	cp -avf qhtlfirewall.directadmin.pignore /etc/qhtlfirewall/qhtlfirewall.pignore
fi
...
chown diradmin:diradmin /usr/local/directadmin/plugins/qhtlfirewall
cp -avf da/* /usr/local/directadmin/plugins/qhtlfirewall/
cp -avf qhtlfirewall/* /usr/local/directadmin/plugins/qhtlfirewall/images/
find /usr/local/directadmin/plugins/qhtlfirewall/ -type d -exec chmod -v 755 {} \;
find /usr/local/directadmin/plugins/qhtlfirewall/ -type f -exec chmod -v 644 {} \;

if [ -e "/usr/local/directadmin/plugins/qhtlfirewall/exec/qhtlfirewall" ]; then
	rm -f /usr/local/directadmin/plugins/qhtlfirewall/exec/qhtlfirewall
fi
export PATH=$PATH;
gcc -o /usr/local/directadmin/plugins/qhtlfirewall/exec/qhtlfirewall qhtlfirewall.c
chown -Rv diradmin:diradmin /usr/local/directadmin/plugins/qhtlfirewall
chmod -v 755 /usr/local/directadmin/plugins/qhtlfirewall/admin/index.html
chmod -v 755 /usr/local/directadmin/plugins/qhtlfirewall/admin/index.raw
chmod -v 755 /usr/local/directadmin/plugins/qhtlfirewall/exec/da_qhtlfirewall.cgi
chmod -v 755 /usr/local/directadmin/plugins/qhtlfirewall/reseller/index.html
chmod -v 755 /usr/local/directadmin/plugins/qhtlfirewall/reseller/index.raw
chmod -v 755 /usr/local/directadmin/plugins/qhtlfirewall/exec/da_qhtlfirewall_reseller.cgi
chmod -v 755 /usr/local/directadmin/plugins/qhtlfirewall/scripts/*
chown -v root:root /usr/local/directadmin/plugins/qhtlfirewall/exec/qhtlfirewall
chmod -v 4755 /usr/local/directadmin/plugins/qhtlfirewall/exec/qhtlfirewall
