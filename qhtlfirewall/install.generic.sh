...
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.conf" ]; then
	cp -avf qhtlfirewall.generic.conf /etc/qhtlfirewall/qhtlfirewall.conf
fi
...
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.allow" ]; then
	cp -avf qhtlfirewall.generic.allow /etc/qhtlfirewall/qhtlfirewall.allow
fi
...
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.ignore" ]; then
	cp -avf qhtlfirewall.generic.ignore /etc/qhtlfirewall/qhtlfirewall.ignore
fi
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.pignore" ]; then
	cp -avf qhtlfirewall.generic.pignore /etc/qhtlfirewall/qhtlfirewall.pignore
fi
...
# Ensure qhtlmanager UI is enabled on generic installs (safe sed)
