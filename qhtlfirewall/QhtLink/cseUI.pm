...
EOF
	...
	unless ($FORM{do} eq "console") {
		...
		print " <a class='btn btn-default' href='$script?qhtlfirewallaction=qhtlfirewalllogout'>cse Logout</a>\n";
		print "</div>\n";
		print <<EOF;
<div class='panel panel-default panel-body'>
<h4><span class="glyphicon glyphicon-folder-open icon-qhtlfirewall"></span> File Explorer</h4>
</div>
EOF
	}
