...
EOF
	...
	print "    <div style='flex:0 0 30%; max-width:30%; display:flex; align-items:center;'>";
	print "      <div style='flex:0 0 30%; max-width:30%'><a class='quickview-link' data-which='allow' href='$script?action=viewlist&which=allow' onclick=\"if(typeof showQuickView==='function'){showQuickView('allow'); return false;} return true;\"><span class='glyphicon glyphicon-cog icon-qhtlfirewall' style='font-size:1.3em;' data-tooltip='tooltip' title='Quick Manual Configuration'></span></a></div>";
	print "      <div style='flex:0 0 70%; max-width:70%'>Allow IP address <input type='text' name='ip' id='allowip' value='' size='36' style='background-color: #BDECB6; width:100%; margin-left:8px;'></div>";
	print "    </div>";
	print "  </div>";
	print "  <div style='display:flex; align-items:center; gap:12px; width:100%; margin-top:8px'>";
	print "    <div style='flex:0 0 30%; max-width:30%; display:flex; align-items:center;'>";
	print "      <div style='flex:0 0 30%; max-width:30%'></div>";
	print "      <div style='flex:0 0 70%; max-width:70%'>Comment for Allow:</div>";
	print "    </div>";
	print "    <div style='flex:1'><input type='text' name='comment' value='' size='30' style='width:100%;'></div>";
	print "  </div>";
	...
	print "  <div style='display:flex; align-items:center; gap:12px; width:100%'>";
	print "    <div style='flex:0 0 30%; max-width:30%; display:flex; align-items:center;'>";
	print "      <div style='flex:0 0 30%; max-width:30%'><a class='quickview-link' data-which='deny' href='$script?action=viewlist&which=deny' onclick=\"if(typeof showQuickView==='function'){showQuickView('deny'); return false;} return true;\"><span class='glyphicon glyphicon-cog icon-qhtlfirewall' style='font-size:1.3em;' data-tooltip='tooltip' title='Quick Manual Configuration'></span></a></div>";
	print "      <div style='flex:0 0 70%; max-width:70%'>Block IP address <input type='text' name='ip' id='denyip' value='' size='36' style='background-color: #FFD1DC; width:100%; margin-left:8px;'></div>";
	print "    </div>";
	print "  </div>";
	print "  <div style='display:flex; align-items:center; gap:12px; width:100%; margin-top:8px'>";
	print "    <div style='flex:0 0 30%; max-width:30%; display:flex; align-items:center;'>";
	print "      <div style='flex:0 0 30%; max-width:30%'></div>";
	print "      <div style='flex:0 0 70%; max-width:70%'>Comment for Block:</div>";
	print "    </div>";
	print "    <div style='flex:1'><input type='text' name='comment' value='' size='30' style='width:100%;'></div>";
	print "  </div>";
	print "</div></form></td></tr>\n";
	...
	print "  <div style='display:flex; align-items:center; gap:12px; width:100%'>";
	print "    <div style='flex:0 0 30%; max-width:30%; display:flex; align-items:center;'>";
	print "      <div style='flex:0 0 30%; max-width:30%'><a class='quickview-link' data-which='ignore' href='$script?action=viewlist&which=ignore' onclick=\"if(typeof showQuickView==='function'){showQuickView('ignore'); return false;} return true;\"><span class='glyphicon glyphicon-cog icon-qhtlfirewall' style='font-size:1.3em;' data-tooltip='tooltip' title='Quick Manual Configuration'></span></a></div>";
	print "      <div style='flex:0 0 70%; max-width:70%'>Ignore IP address <input type='text' name='ip' id='ignoreip' value='' size='36' style='background-color: #D9EDF7; width:100%; margin-left:8px;'></div>";
	print "    </div>";
	print "  </div>";
	print "</div></form></td></tr>\n";
	...
	print "<div id='qhtlwaterfall' class='tab-pane'>\n";
		...
		print "<tr><td><form action='$script' method='post'><input type='hidden' name='action' value='qhtlwaterfallrestart'><input type='submit' class='btn btn-default' value='qhtlwaterfall Restart'></form></td><td style='width:100%'>Restart qhtlwaterfall</td></tr>\n";
		...
		print "</select> <input type='submit' class='btn btn-default' value='Edit'></form></td><td style='width:100%'>Edit qhtlwaterfall ignore file</td></tr>\n";
