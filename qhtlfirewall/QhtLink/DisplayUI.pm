...
EOF
	...
	print "    <div style='margin-top:8px;'>Comment for Allow:</div>";
	print "  </div>";
	print "  <div style='flex:1'>";
	print "    <form action='$script' method='post' id='qallow'>";
	print "      <input type='submit' class='hide'><input type='hidden' name='action' value='qallow'>";
	print "      <input type='text' name='ip' id='allowip' value='' size='36' style='background-color: #BDECB6; width:100%;'>";
	print "      <br>";
	...
	print "    <div style='margin-top:8px;'>Comment for Block:</div>";
	print "  </div>";
	print "  <div style='flex:1'>";
	print "    <form action='$script' method='post' id='qdeny'>";
	print "      <input type='submit' class='hide'><input type='hidden' name='action' value='qdeny'>";
	print "      <input type='text' name='ip' id='denyip' value='' size='36' style='background-color: #FFD1DC; width:100%;'>";
	print "      <br>";
	print "      <input type='text' name='comment' value='' size='30' style='width:100%;'>";
	print "    </form>";
	print "  </div>";
	...
	print "<div style='display:flex; align-items:flex-start; gap:12px; width:100%'>";
	print "  <div style='flex:1'>";
	print "    <div>Ignore IP address <a class='quickview-link' data-which='ignore' href='$script?action=viewlist&which=ignore' onclick=\"if(typeof showQuickView==='function'){showQuickView('ignore'); return false;} return true;\"><span class='glyphicon glyphicon-cog icon-qhtlfirewall' style='font-size:1.3em; margin-right:12px;' data-tooltip='tooltip' title='Quick Manual Configuration'></span></a></div>";
	print "  </div>";
	print "  <div style='flex:1'>";
	print "    <form action='$script' method='post' id='qignore'>";
	print "      <input type='submit' class='hide'><input type='hidden' name='action' value='qignore'>";
	print "      <input type='text' name='ip' id='ignoreip' value='' size='36' style='background-color: #D9EDF7; width:100%;'>";
	print "    </form>";
	print "  </div>";
	print "</div></td></tr>\n";
