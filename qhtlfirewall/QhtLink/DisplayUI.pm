...
QHTL_UPGRADE_PROGRESS_JS
	...
	print "  <button id='qhtl-upgrade-manual' type='button' title='Check Manually' style='all:unset;margin:0 24px' onclick='return false;'><span class='qhtl-tri-btn secondary'><svg class='tri-svg' viewBox='0 0 100 86.6' preserveAspectRatio='none' aria-hidden='true'><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='white' stroke-width='26' stroke-linejoin='round'/><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='#1e6fd1' stroke-width='6' stroke-linejoin='round'/></svg><span class='tri'></span><span>Check Manually</span></span></button>";
	print "  <button id='qhtl-upgrade-changelog' type='button' title='View ChangeLog' style='all:unset;margin:0 24px' onclick='return false;'><span class='qhtl-tri-btn secondary'><svg class='tri-svg' viewBox='0 0 100 86.6' preserveAspectRatio='none' aria-hidden='true'><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='white' stroke-width='26' stroke-linejoin='round'/><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='#1e6fd1' stroke-width='6' stroke-linejoin='round'/></svg><span class='tri'></span><span>View ChangeLog</span></span></button>";
		# New independent triangles (placeholders)
	print "  <button id='qhtl-upgrade-rex' type='button' title='Rex' style='all:unset;margin:0 24px' onclick='return false;'><span class='qhtl-tri-btn secondary'><svg class='tri-svg' viewBox='0 0 100 86.6' preserveAspectRatio='none' aria-hidden='true'><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='white' stroke-width='26' stroke-linejoin='round'/><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='#1e6fd1' stroke-width='6' stroke-linejoin='round'/></svg><span class='tri'></span><span>Rex</span></span></button>";
	print "  <button id='qhtl-upgrade-mpass' type='button' title='Mpass' style='all:unset;margin:0 24px' onclick='return false;'><span class='qhtl-tri-btn secondary'><svg class='tri-svg' viewBox='0 0 100 86.6' preserveAspectRatio='none' aria-hidden='true'><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='white' stroke-width='26' stroke-linejoin='round'/><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='#1e6fd1' stroke-width='6' stroke-linejoin='round'/></svg><span class='tri'></span><span>Mpass</span></span></button>";
	print "  <button id='qhtl-upgrade-mshield' type='button' title='Mshield' style='all:unset;margin:0 24px' onclick='return false;'><span class='qhtl-tri-btn secondary'><svg class='tri-svg' viewBox='0 0 100 86.6' preserveAspectRatio='none' aria-hidden='true'><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='white' stroke-width='26' stroke-linejoin='round'/><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='#1e6fd1' stroke-width='6' stroke-linejoin='round'/></svg><span class='tri'></span><span>Mshield</span></span></button>";
		print "</div>";
		print "<script src='$script?action=widget_js&name=uupdate.js'></script>";
