...
QHTL_ADV_RESET_JS
	...
	print "  #moreplus .qhtl-hex-btn{position:relative;width:70px;height:70px;cursor:pointer;border:none;padding:4px 4px;background:linear-gradient(135deg,#b8860b,#ffd700,#d4af37);\n";
		...
		print "    box-shadow:0 0 6px 3px rgba(255,225,120,0.95),0 0 14px 6px rgba(255,225,120,0.85),0 0 26px 12px rgba(255,215,90,0.70),0 0 50px 26px rgba(255,235,150,0.60),0 0 74px 34px rgba(255,240,190,0.45);\n";
		print "    border:1px solid rgba(255,255,255,0.5);\n";
		print "    transition:transform .15s ease, box-shadow .25s ease;\n";
	print "  }\n";
	print "  #moreplus .qhtl-hex-btn:after{content:'';position:absolute;inset:-9px;pointer-events:none;clip-path:inherit;border-radius:14px;z-index:-1;\n";
	print "    background:radial-gradient(circle at 50% 50%, rgba(255,255,255,0.70) 0%, rgba(255,235,150,0.55) 38%, rgba(255,215,0,0.28) 62%, rgba(255,215,0,0) 78%); mix-blend-mode:screen; opacity:1; filter:blur(3px);\n";
	print "  }\n";
	print "  #moreplus .qhtl-hex-btn:hover{transform:translateY(-3px) scale(1.05); box-shadow:0 0 8px 4px rgba(255,235,150,0.98),0 0 18px 8px rgba(255,235,150,0.90),0 0 32px 16px rgba(255,225,120,0.85),0 0 60px 30px rgba(255,240,190,0.65);}\n";
	print "  #moreplus .qhtl-hex-btn:active{transform:translateY(0) scale(.95); box-shadow:0 0 4px 2px rgba(255,215,0,0.95),0 0 12px 6px rgba(255,205,0,0.75),0 0 22px 12px rgba(255,205,0,0.55);}\n";
		print "    transition:transform .12s ease, box-shadow .12s ease;\n";
		print "  }\n";
	print "  /* Restored luminous halo via :before pseudo-element */\n";
	print "  #moreplus .qhtl-hex-btn:before{content:'';position:absolute;inset:-14px;clip-path:inherit;border-radius:22px;pointer-events:none;z-index:-2;\n";
	print "    background:radial-gradient(circle at 50% 50%, rgba(255,255,255,0.90) 0%, rgba(255,240,180,0.70) 36%, rgba(255,225,110,0.40) 60%, rgba(255,215,0,0.10) 75%, rgba(255,215,0,0) 82%);\n";
	print "    box-shadow:0 0 10px 5px rgba(255,255,210,0.95),0 0 22px 12px rgba(255,240,160,0.85),0 0 40px 22px rgba(255,225,100,0.60),0 0 80px 44px rgba(255,230,130,0.45);\n";
