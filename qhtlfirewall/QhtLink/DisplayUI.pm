...
sub systemstats {
	...
	print "<div class='text-center'><form id='qhtl-systemstats-form' action='${script}' method='post' data-noajax='1'><input type='hidden' name='action' value='systemstats'><select name='graph'>\n";
		my $selected;
