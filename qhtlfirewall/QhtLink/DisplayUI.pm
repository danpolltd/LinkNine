...
QHTL_UPGRADE_PROGRESS_JS
	...
	print "  <button id='qhtl-upgrade-mpass' type='button' title='Mail Moderator' style='all:unset;margin:0 24px' onclick='return false;'><span class='qhtl-tri-btn secondary'><svg class='tri-svg' viewBox='0 0 100 86.6' preserveAspectRatio='none' aria-hidden='true'><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='white' stroke-width='8' stroke-linejoin='round'/><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='#1e6fd1' stroke-width='5' stroke-linejoin='round'/></svg><span class='tri'></span><span>Mail Moderator</span></span></button>";
	print "  <button id='qhtl-upgrade-mshield' type='button' title='Mail Shiled' style='all:unset;margin:0 24px' onclick='return false;'><span class='qhtl-tri-btn secondary'><svg class='tri-svg' viewBox='0 0 100 86.6' preserveAspectRatio='none' aria-hidden='true'><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='white' stroke-width='8' stroke-linejoin='round'/><polygon points='50,3 96,83.6 4,83.6' fill='none' stroke='#1e6fd1' stroke-width='5' stroke-linejoin='round'/></svg><span class='tri'></span><span>Mail Shiled</span></span></button>";
		print "</div>";
		print "<script src='$script?action=widget_js&name=uupdate.js'></script>";
