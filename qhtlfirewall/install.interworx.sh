...
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.conf" ]; then
	cp -avf qhtlfirewall.interworx.conf /etc/qhtlfirewall/qhtlfirewall.conf
fi
...
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.allow" ]; then
	cp -avf qhtlfirewall.interworx.allow /etc/qhtlfirewall/qhtlfirewall.allow
fi
...
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.ignore" ]; then
	cp -avf qhtlfirewall.interworx.ignore /etc/qhtlfirewall/qhtlfirewall.ignore
fi
if [ ! -e "/etc/qhtlfirewall/qhtlfirewall.pignore" ]; then
	cp -avf qhtlfirewall.interworx.pignore /etc/qhtlfirewall/qhtlfirewall.pignore
fi
...
# Ensure qhtlmanager UI is enabled on Interworx installs (safe sed)
