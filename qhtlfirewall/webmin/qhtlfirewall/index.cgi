...
unless ($FORM{action} eq "tailcmd" or $FORM{action} =~ /^cf/ or $FORM{action} eq "logtailcmd" or $FORM{action} eq "loggrepcmd") {
	...
	print "		});\n";
	if ($config{STYLE_MOBILE}) {
		print "		var qhtlfirewallview = getCookie('qhtlfirewallview');\n";
		print "		if (qhtlfirewallview == 'mobile') {\n";
		print "			\$('.mobilecontainer').css('display','block');\n";
		print "			\$('.normalcontainer').css('display','none');\n";
		print "			\$('#qhtlfirewallreturn').addClass('btn-primary btn-lg btn-block').removeClass('btn-default');\n";
		print "		} else if (qhtlfirewallview == 'desktop') {\n";
		print "			\$('.mobilecontainer').css('display','none');\n";
		print "			\$('.normalcontainer').css('display','block');\n";
		print "			\$('#qhtlfirewallreturn').removeClass('btn-primary btn-lg btn-block').addClass('btn-default');\n";
		print "		}\n";
		...
		print "			document.cookie = 'qhtlfirewallview=mobile; path=/';\n";
		print "			if (top.location != location) {\n";
	...
	if ($config{STYLE_MOBILE}) {
		...
		print "		document.cookie = 'qhtlfirewallview=desktop; path=/';\n";
		print "		\$('.mobilecontainer').css('display','none');\n";
		print "		\$('.normalcontainer').css('display','block');\n";
		print "	});\n";
