...
main ()
{
	...
	if (admin == 1)
	{
		...
		execv("/usr/local/directadmin/plugins/qhtlfirewall/exec/da_qhtlfirewall.cgi", NULL);
	} else {
		...
		if (reseller == 1)
		{
			...
			execv("/usr/local/directadmin/plugins/qhtlfirewall/exec/da_qhtlfirewall_reseller.cgi", NULL);
		} else {
