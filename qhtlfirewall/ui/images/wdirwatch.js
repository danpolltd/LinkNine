(function(){
  window.WDirWatch = {
    mountInline: function(anchor){ try { var el = typeof anchor==='string'?document.querySelector(anchor):anchor; if(!el) return false; ensure(); el.appendChild(make('Dir Watch')); return true; } catch(e){ return false; } }
  };
