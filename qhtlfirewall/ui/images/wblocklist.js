(function(){
  window.WBlocklist = {
    mountInline: function(anchor){ try { var el = typeof anchor==='string'?document.querySelector(anchor):anchor; if(!el) return false; ensure(); el.appendChild(make('Blocklist')); return true; } catch(e){ return false; } }
  };
