...
if (&checkversion("7.72") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto772") {
	my %pignore = (
		...
		'exe:/usr/sbin/exim' => 1);
	sysopen (IN,"/etc/qhtlfirewall/qhtlfirewall.pignore", O_RDWR | O_CREAT);
	flock (IN, LOCK_EX);
	my @data = <IN>;
	chomp @data;
	seek (IN, 0, 0);
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto772");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("8.04") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto804") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto804");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("8.06") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto806") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto806");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("8.13") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto813") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto813");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("8.26") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto826") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto826");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("8.27") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto827") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto827");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("9.00") and !-e "/var/lib/qhtlfirewall/auto900") {
	my %pignore = (
	...
	my %allow = (
		'Include /etc/qhtlfirewall/cpanel.comodo.allow' => 1);
	...
	my %ignore = (
		'Include /etc/qhtlfirewall/cpanel.comodo.ignore' => 1);
	...
	open (OUT, ">", "/var/lib/qhtlfirewall/auto900");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("9.12") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto912") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto912");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("10.02") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto1002") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1002");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("10.06") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto1006") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1006");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("10.08") and !-e "/var/lib/qhtlfirewall/auto1008") {
	my %allow = (
		'Include /etc/qhtlfirewall/cpanel.allow' => 1);
	sysopen (IN,"/etc/qhtlfirewall/qhtlfirewall.allow", O_RDWR | O_CREAT);
	flock (IN, LOCK_EX);
	my @data = <IN>;
	chomp @data;
	...
	my %ignore = (
		'Include /etc/qhtlfirewall/cpanel.ignore' => 1);
	sysopen (IN,"/etc/qhtlfirewall/qhtlfirewall.ignore", O_RDWR | O_CREAT);
	flock (IN, LOCK_EX);
	@data = <IN>;
	chomp @data;
	...
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1008");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
...
if (&checkversion("11.07") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto1107") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1107");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
...
if (&checkversion("12.05") and !-e "/var/lib/qhtlfirewall/auto1205") {
	if (-e "/etc/qhtlfirewall/qhtlfirewall.blocklists") {
		sysopen (IN,"/etc/qhtlfirewall/qhtlfirewall.blocklists", O_RDWR | O_CREAT);
		flock (IN, LOCK_EX);
		my @data = <IN>;
	...
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1205");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("12.07") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto1207") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1207");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("12.10") and -e "/etc/qhtlfirewall/qhtlfirewall.fignore" and !-e "/var/lib/qhtlfirewall/auto1210") {
	my %fignore = ('/tmp/yarn--[\d\-\.]+/(node|yarn)' => 1);
	sysopen (IN,"/etc/qhtlfirewall/qhtlfirewall.fignore", O_RDWR | O_CREAT);
	flock (IN, LOCK_EX);
	my @data = <IN>;
	chomp @data;
	seek (IN, 0, 0);
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1210");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("14.01") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto1401") {
	sysopen (IN,"/etc/qhtlfirewall/qhtlfirewall.pignore", O_RDWR | O_CREAT);
	flock (IN, LOCK_EX);
	my @data = <IN>;
	chomp @data;
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1401");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("14.02") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto1402") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1402");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
...
if (&checkversion("14.05") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto1405") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1405");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("14.06") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto1406") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1406");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
if (&checkversion("14.18") and -e "/etc/qhtlfirewall/qhtlfirewall.pignore" and !-e "/var/lib/qhtlfirewall/auto1418") {
	my %pignore = (
	...
	close (IN);
	open (OUT, ">", "/var/lib/qhtlfirewall/auto1418");
	flock (OUT, LOCK_EX);
	print OUT time;
	close (OUT);
}
...
if (-e "/usr/local/qhtlfirewall/tpl/reselleralert.txt") {
	sysopen (IN,"/usr/local/qhtlfirewall/tpl/reselleralert.txt", O_RDWR | O_CREAT);
	flock (IN, LOCK_EX);
	my @data = <IN>;
	chomp @data;
	seek (IN, 0, 0);
...
if (not grep {$_ =~ /^qhtlwaterfall/} @chkservd) {
	open (OUT,">", "/etc/chkserv.d/qhtlwaterfall");
	flock (OUT, LOCK_EX);
	print OUT "service[qhtlwaterfall]=x,x,x,service qhtlwaterfall restart,qhtlwaterfall,root\n";
	close (OUT);

	sysopen (OUT,"/etc/chkserv.d/chkservd.conf", O_WRONLY | O_CREAT);
	flock (OUT, LOCK_EX);
	foreach my $line (@chkservd) {print OUT "$line\n"}
	print OUT "qhtlwaterfall:1\n";
	close OUT;
}
...
open (IN, "<", "qhtlfirewall.conf") or die $!;
flock (IN, LOCK_SH) or die $!;
my @config = <IN>;
close (IN);
chomp @config;
...
if ($config{TESTING}) {
	...
	print "1. Configure the following options in the qhtlfirewall configuration to suite your server: $opts\n";
...
if ($config{MESSENGERV2}) {
	...
	while (my $line = <$ALIASES>) {
		...
		if ($alias eq "qhtlfirewall") {
			$hit = 1;
			last;
		}
	}
	close ($ALIASES);
	if (!$hit and !-e "/var/cpanel/users/qhtlfirewall") {
		system("/bin/cp /etc/aliases /etc/aliases.".time);
		open (my $ALIASESw, ">>", "/etc/aliases");
		flock ($ALIASESw, LOCK_EX);
		print $ALIASESw "qhtlfirewall: root\n";
		close ($ALIASESw);
		print "Account [qhtlfirewall] added /etc/aliases to prevent cPanel account with the same name (for MESSENGERV2)\n";
	}
}

exit;
###############################################################################
sub loadqhtlfirewallconfig {
	open (IN, "<", "/etc/qhtlfirewall/qhtlfirewall.conf") or die $!;
	flock (IN, LOCK_SH) or die $!;
	my @config = <IN>;
	close (IN);
