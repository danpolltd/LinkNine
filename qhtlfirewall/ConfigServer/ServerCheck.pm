...
sub firewallcheck {
	...
	&addline($status,"AUTO_UPDATES option check","To keep qhtlfirewall up to date and secure you should enable AUTO_UPDATES. You should also monitor our <a href='http://blog.configserver.com' target='_blank'>blog</a>");
