...
class Plugin_Configserverqhtlfirewall extends Plugin
{
    ...
    public function runReseller()
    {
        ...
        $user = 'root';
        $cmd .= " {$user} custom /usr/local/interworx/plugins/configserverqhtlfirewall/lib/reseller.pl 2>&1";
    ...
    public function runAdmin()
    {
        ...
        $user = 'root';
        $cmd .= " {$user} custom /usr/local/interworx/plugins/configserverqhtlfirewall/lib/index.pl 2>&1";
    ...
    public function updateNodeworxMenu(IWorxMenuManager $MenuMan)
    {
		...
		$new_data = array( 'text' => 'Security & Firewall',
                       'url' => '/nodeworx/configserverqhtlfirewall?action=launch',
